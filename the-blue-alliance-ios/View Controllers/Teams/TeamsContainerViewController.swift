...
extension TeamsContainerViewController: TeamsViewControllerDelegate {
    ...
    func teamSelected(_ team: Team) {
        ...
        let teamViewController = TeamViewController(team: team, remoteConfig: remoteConfig, urlOpener: urlOpener, myTBA: myTBA, persistentContainer: persistentContainer, tbaKit: tbaKit, userDefaults: userDefaults)
