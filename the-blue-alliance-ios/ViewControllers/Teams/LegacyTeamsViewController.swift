 ...
 */
// Legacy Core-Data-backed base class — only `DistrictTeamsViewController`
// and `EventTeamsViewController` still consume it. Phase 4 (Districts) and
// a Phase 3 follow-up migrate them off, at which point this file is deleted.
class LegacyTeamsViewController: TBASearchableTableViewController, Refreshable, Stateful, TeamsViewControllerDataSourceConfiguration {
