...
class EventInsightsConfigurator2016: EventInsightsConfigurator {
    ...
    static func configureDataSource(
        ...
        matchStats.append(
            scoreRow(
                title: "Average Auto Score",
                key: "average_auto_score",
                qual: qual,
                playoff: playoff
            )
        )
        matchStats.append(
            scoreRow(
                title: "Average Teleop Crossing Score",
                key: "average_crossing_score",
                qual: qual,
                playoff: playoff
            )
        )
        matchStats.append(
            scoreRow(
                title: "Average Teleop Boulder Score",
                key: "average_boulder_score",
                qual: qual,
                playoff: playoff
            )
        )
        matchStats.append(
            scoreRow(
                title: "Average Teleop Tower Score",
                key: "average_tower_score",
                qual: qual,
                playoff: playoff
            )
        )
        ...
        towerStats.append(
            bonusRow(title: "Challenges", key: "challenges", qual: qual, playoff: playoff)
        )
        towerStats.append(bonusRow(title: "Scales", key: "scales", qual: qual, playoff: playoff))
        towerStats.append(
            bonusRow(title: "Captures", key: "captures", qual: qual, playoff: playoff)
        )
        ...
        if !towerStats.isEmpty {
            ...
            snapshot.appendItems(
                towerStats,
                toSection: "Tower Stats (# successful / # opportunities)"
            )
        }
        ...
        defenseStats.append(
            bonusRow(title: "Cheval De Frise", key: "A_ChevalDeFrise", qual: qual, playoff: playoff)
        )
        defenseStats.append(
            bonusRow(title: "Portcullis", key: "A_Portcullis", qual: qual, playoff: playoff)
        )
        defenseStats.append(
            bonusRow(title: "Ramparts", key: "B_Ramparts", qual: qual, playoff: playoff)
        )
        defenseStats.append(bonusRow(title: "Moat", key: "B_Moat", qual: qual, playoff: playoff))
        defenseStats.append(
            bonusRow(title: "Sally Port", key: "C_SallyPort", qual: qual, playoff: playoff)
        )
        defenseStats.append(
            bonusRow(title: "Drawbridge", key: "C_Drawbridge", qual: qual, playoff: playoff)
        )
        defenseStats.append(
            bonusRow(title: "Rough Terrain", key: "D_RoughTerrain", qual: qual, playoff: playoff)
        )
        defenseStats.append(
            bonusRow(title: "Rock Wall", key: "D_RockWall", qual: qual, playoff: playoff)
        )
        defenseStats.append(
            bonusRow(title: "Total Breaches", key: "breaches", qual: qual, playoff: playoff)
        )
        ...
        if !defenseStats.isEmpty {
            ...
            snapshot.appendItems(
                defenseStats,
                toSection: "Defense Stats (# damaged / # opportunities)"
            )
        }
