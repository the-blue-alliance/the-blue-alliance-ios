    ...
    static func configureDataSource(
        ...
        matchStats.append(
            scoreRow(
                ...
                key: "average_scale_ownership_points",
                qual: qual,
                playoff: playoff
            )
        )
        matchStats.append(
            scoreRow(
                ...
                key: "average_switch_ownership_points",
                qual: qual,
                playoff: playoff
            )
        )
        ...
        matchStats.append(
            scoreRow(
                ...
                key: "winning_scale_ownership_percentage",
                qual: qual,
                playoff: playoff
            )
        )
        matchStats.append(
            scoreRow(
                ...
                key: "winning_own_switch_ownership_percentage",
                qual: qual,
                playoff: playoff
            )
        )
