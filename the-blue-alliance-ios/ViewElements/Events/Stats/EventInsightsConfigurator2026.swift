...
class EventInsightsConfigurator2026: EventInsightsConfigurator {
    ...
    static func configureDataSource(_ snapshot: inout NSDiffableDataSourceSnapshot<String, InsightRow>, _ qual: [String : Any]?, _ playoff: [String : Any]?) {
        ...
        if !bonusStats.isEmpty {
            ...
            snapshot.appendItems(bonusStats, toSection: "Bonus Stats (Count / Opportunities / Sucess)")
        }
        
        var fuelStats: [InsightRow] = []
        
        fuelStats.append(totalsRow(title: "Auto Fuel Scored", key: "auto_fuel_scored", qual: qual, playoff: playoff))
        fuelStats.append(totalsRow(title: "Teleop Fuel Scored", key: "teleop_fuel_scored", qual: qual, playoff: playoff))
        fuelStats.append(totalsRow(title: "Total Fuel Scored", key: "total_fuel_scored", qual: qual, playoff: playoff))
        ...
        towerStats.append(bonusRow(title: "Auto Climb", key: "auto_climb_count", qual: qual, playoff: playoff))
        towerStats.append(bonusRow(title: "Level 1 Climb", key: "level1_climb_count", qual: qual, playoff: playoff))
        towerStats.append(bonusRow(title: "Level 2 Climb", key: "level2_climb_count", qual: qual, playoff: playoff))
        towerStats.append(bonusRow(title: "Level 3 Climb", key: "level3_climb_count", qual: qual, playoff: playoff))
        ...
        if !towerStats.isEmpty {
            ...
            snapshot.appendItems(towerStats, toSection: "Tower Stats (Count / Opportunities / Sucess)")
        }
