...
class EventInsightsConfigurator2020: EventInsightsConfigurator {
    ...
    static func configureDataSource(
        ...
        bonusStats.append(
            bonusRow(
                title: "Exit Initiation Line",
                key: "exit_init_line_count",
                qual: qual,
                playoff: playoff
            )
        )
        bonusStats.append(
            bonusRow(
                title: "Achieve Stage 1",
                key: "achieve_stage1_count",
                qual: qual,
                playoff: playoff
            )
        )
        bonusStats.append(
            bonusRow(
                title: "Achieve Stage 2",
                key: "achieve_stage2_count",
                qual: qual,
                playoff: playoff
            )
        )
        bonusStats.append(
            bonusRow(
                title: "Achieve Stage 3",
                key: "achieve_stage3_count",
                qual: qual,
                playoff: playoff
            )
        )
        bonusStats.append(
            bonusRow(title: "Endgame Parking", key: "park_count", qual: qual, playoff: playoff)
        )
        bonusStats.append(
            bonusRow(title: "Endgame Hanging", key: "hang_count", qual: qual, playoff: playoff)
        )
        bonusStats.append(
            bonusRow(
                title: "Generator Level + Hang",
                key: "generator_level_count",
                qual: qual,
                playoff: playoff
            )
        )
        bonusStats.append(
            bonusRow(
                title: "Shield Generator Operational RP Achieved",
                key: "generator_operational_rp_achieved",
                qual: qual,
                playoff: playoff
            )
        )
        bonusStats.append(
            bonusRow(
                title: "Shield Generator Energized RP Achieved",
                key: "generator_energized_rp_achieved",
                qual: qual,
                playoff: playoff
            )
        )
        bonusStats.append(
            bonusRow(
                title: "\"Unicorn Matches\" (Win + Generator Operational + Generator Energized)",
                key: "unicorn_matches",
                qual: qual,
                playoff: playoff
            )
