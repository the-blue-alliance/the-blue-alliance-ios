...
struct MatchBreakdownConfigurator2026: MatchBreakdownConfigurator {
    ...
    static func configureDataSource(
        ...
        rows.append(
            nestedRow(
                title: "Auto Fuel",
                keyPath: ["hubScore", "autoPoints"],
                red: red,
                blue: blue
            )
        )
        rows.append(
            row(title: "Total Auto", key: "totalAutoPoints", red: red, blue: blue, type: .total)
        )
        // Teleop
        rows.append(
            nestedRow(
                title: "Transition Shift Fuel",
                keyPath: ["hubScore", "transitionCount"],
                red: red,
                blue: blue
            )
        )
        ...
        rows.append(
            nestedRow(
                title: "Teleop Fuel Points",
                keyPath: ["hubScore", "teleopPoints"],
                red: red,
                blue: blue,
                type: .subtotal
            )
        ...
        rows.append(
            row(
                title: "Endgame Tower Points",
                key: "endGameTowerPoints",
                red: red,
                blue: blue,
                type: .subtotal
            )
        ...
        rows.append(
            row(
                title: "Total Tower Points",
                key: "totalTowerPoints",
                red: red,
                blue: blue,
                type: .subtotal
            )
        ...
        rows.append(
            row(title: "Total Teleop", key: "totalTeleopPoints", red: red, blue: blue, type: .total)
        )
        // RP
        rows.append(
            boolImageRow(title: "Engergized Bonus", key: "energizedAchieved", red: red, blue: blue)
        )
        rows.append(
            boolImageRow(
                title: "Supercharged Bonus",
                key: "superchargedAchieved",
                red: red,
                blue: blue
            )
        )
