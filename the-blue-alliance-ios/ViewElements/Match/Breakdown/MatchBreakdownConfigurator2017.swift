...
struct MatchBreakdownConfigurator2017: MatchBreakdownConfigurator {
    ...
    static func configureDataSource(
        ...
        rows.append(
            row(
                title: "Mobility Points",
                key: "autoMobilityPoints",
                red: red,
                blue: blue,
                type: .subtotal
            )
        ...
        rows.append(
            row(
                title: "Takeoff Points",
                key: "teleopTakeoffPoints",
                red: red,
                blue: blue,
                type: .subtotal
            )
        ...
        rows.append(
            boolImageRow(
                title: "Pressure Reached",
                key: "kPaRankingPointAchieved",
                red: red,
                blue: blue
            )
        )
        rows.append(
            boolImageRow(
                title: "All Rotors Engaged",
                key: "rotorRankingPointAchieved",
                red: red,
                blue: blue
            )
        )
    ...
    private static func teleopRotorRow(
        title: String,
        key: String,
        autonKey: String,
        red: [String: Any]?,
        ...
        return BreakdownRow(
            title: title,
            red: [redBool ? rRotor : nil],
            blue: [blueBool ? bRotor : BreakdownStyle.checkImage],
            type: type,
            offset: offset
        )
    }
