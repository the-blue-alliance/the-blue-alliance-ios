...
struct MatchBreakdownConfigurator2016: MatchBreakdownConfigurator {
    ...
    static func configureDataSource(
        ...
        // Auto
        rows.append(
            row(title: "Auto Boulder Points", key: "autoBoulderPoints", red: red, blue: blue)
        )
        rows.append(row(title: "Auto Reach Points", key: "autoReachPoints", red: red, blue: blue))
        rows.append(
            row(title: "Auto Crossing Points", key: "autoCrossingPoints", red: red, blue: blue)
        )
        ...
        rows.append(
            defenseRow(
                title: "Defense 2",
                key: "position2crossings",
                defenseKey: "position2",
                red: red,
                blue: blue
            )
        )
        rows.append(
            defenseRow(
                title: "Defense 3 (Audience)",
                key: "position3crossings",
                defenseKey: "position3",
                red: red,
                blue: blue
            )
        )
        rows.append(
            defenseRow(
                title: "Defense 4",
                key: "position4crossings",
                defenseKey: "position4",
                red: red,
                blue: blue
            )
        )
        rows.append(
            defenseRow(
                title: "Defense 5",
                key: "position5crossings",
                defenseKey: "position5",
                red: red,
                blue: blue
            )
        )
        rows.append(
            row(
                title: "Teleop Crossing Points",
                key: "teleopCrossingPoints",
                red: red,
                blue: blue,
                type: .subtotal
            )
        ...
        rows.append(
            row(
                title: "Teleop Boulders High",
                key: "teleopBouldersHigh",
                formatString: "%@ x \(5) points",
                red: red,
                blue: blue
            )
        )
        rows.append(
            row(
                title: "Teleop Boulders Low",
                key: "teleopBouldersLow",
                formatString: "%@ x \(2) points",
                red: red,
                blue: blue
            )
        )
        rows.append(
            row(
                title: "Total Telop Boulder",
                key: "teleopBoulderPoints",
                red: red,
                blue: blue,
                type: .subtotal
            )
        ...
        rows.append(
            row(title: "Tower Challenge Points", key: "teleopChallengePoints", red: red, blue: blue)
        )
        rows.append(
            row(title: "Tower Scale Points", key: "teleopScalePoints", red: red, blue: blue)
        )
        rows.append(
        ...
        rows.append(
            boolImageRow(
                ...
                key: "teleopDefensesBreached",
                red: red,
                blue: blue
            )
        )
        rows.append(
            boolImageRow(title: "Tower Captured", key: "teleopTowerCaptured", red: red, blue: blue)
        )
        rows.append(
    ...
    private static func defenseRow(
        title: String,
        key: String,
        defenseKey: String,
        red: [String: Any]?,
    ...
    private static func defenseRow(
        ...
        let svs = [(redDefense, redCrosses), (blueDefense, blueCrosses)].map {
            (defense, crosses) -> UIStackView in
