...
struct MatchBreakdownConfigurator2015: MatchBreakdownConfigurator {
    ...
    static func configureDataSource(
        ...
        rows.append(
            boolRow(title: "Container Set", key: "container_set", red: red, blue: blue, value: 8)
        )
        rows.append(boolRow(title: "Tote Set", key: "tote_set", red: red, blue: blue, value: 6))
        rows.append(
            boolRow(title: "Tote Stack", key: "tote_stack", red: red, blue: blue, value: 20)
        )
        rows.append(
            row(title: "Total Auto", key: "auto_points", red: red, blue: blue, type: .total)
        )
        // Teleop
        ...
        rows.append(
            row(title: "Total Teleop", key: "teleop_points", red: red, blue: blue, type: .total)
        )
        // Final
    ...
    private static func coopertitionRow(dict: [String: Any]?) -> BreakdownRow? {
        ...
        return BreakdownRow(
            title: "Coopertition",
            red: [String(coopertition)],
            blue: [String(coopertition)]
        )
    }
