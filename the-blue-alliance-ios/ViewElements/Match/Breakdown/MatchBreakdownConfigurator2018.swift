...
struct MatchBreakdownConfigurator2018: MatchBreakdownConfigurator {
    ...
    static func configureDataSource(
        ...
        rows.append(
            row(
                title: "Scale Ownership (seconds)",
                key: "autoScaleOwnershipSec",
                red: red,
                blue: blue
            )
        )
        ...
        rows.append(
            row(
                title: "Scale Ownership + Boost (seconds)",
                keys: ["teleopScaleOwnershipSec", "teleopScaleBoostSec"],
                formatString: "%@ + %@",
                red: red,
                blue: blue,
                type: .total
        ...
        rows.append(
            row(
                title: "Switch Ownership + Boost (seconds)",
                keys: ["teleopSwitchOwnershipSec", "teleopSwitchBoostSec"],
                formatString: "%@ + %@",
                red: red,
                blue: blue,
                type: .total
        ...
        rows.append(
            row(
                title: "Force Cubes Total (Played)",
                keys: ["vaultForceTotal", "vaultForcePlayed"],
                formatString: "%@ (%@)",
                red: red,
                blue: blue,
                type: .total
        ...
        rows.append(
            row(
                title: "Levitate Cubes Total (Played)",
                keys: ["vaultLevitateTotal", "vaultLevitatePlayed"],
                formatString: "%@ (%@)",
                red: red,
                blue: blue,
                type: .total
        ...
        rows.append(
            row(
                title: "Boost Cubes Total (Played)",
                keys: ["vaultBoostTotal", "vaultBoostPlayed"],
                formatString: "%@ (%@)",
                red: red,
                blue: blue,
                type: .total
        ...
        // Final
        rows.append(
            boolImageRow(title: "Auto Quest", key: "autoQuestRankingPoint", red: red, blue: blue)
        )
        rows.append(
            boolImageRow(
                title: "Face The Boss",
                key: "faceTheBossRankingPoint",
                red: red,
                blue: blue
            )
        )
