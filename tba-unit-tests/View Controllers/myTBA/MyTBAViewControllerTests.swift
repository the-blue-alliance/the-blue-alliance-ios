...
class MyTBAViewControllerTests: TBATestCase {
    ...
    override func setUp() {
        ...
        myTBAViewController = MyTBAViewController(clientID: "clientID", myTBA: myTBA, statusService: statusService, urlOpener: urlOpener, dependencies: dependencies)
    ...
    func test_authenticated() {
        ...
        let mock = MockMyTBAViewController(clientID: "clientID", myTBA: myTBA, statusService: statusService, urlOpener: urlOpener, dependencies: dependencies)
        mock.viewDidLoad()
