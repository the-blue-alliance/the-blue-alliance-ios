...
class EventStatusTestCase: TBADataTestCase {
    ...
    func test_insert() {
        ...
        let status = EventStatus.insert(model, in: viewContext)
    ...
    func test_update() {
        ...
        let statusOne = EventStatus.insert(modelOne, in: viewContext)
        ...
        let statusTwo = EventStatus.insert(modelTwo, in: viewContext)
    ...
    func test_delete_qual() {
        ...
        let status = EventStatus.insert(modelStatus, in: viewContext)
        ...
        let ranking = EventRanking.insert(modelRanking, sortOrderInfo: nil, extraStatsInfo: nil, eventKey: event.key!, in: viewContext)
