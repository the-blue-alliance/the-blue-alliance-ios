...
class EventRankingTestCase: TBADataTestCase {
    ...
    func test_insert() {
        ...
        let ranking = EventRanking.insert(model, sortOrderInfo: sortOrderInfo, extraStatsInfo: extraStatsInfo, eventKey: event.key!, in: viewContext)
    ...
    func test_insertPredicate() {
        ...
        ranking.teamKey = TeamKey.insert(withKey: "frc1", in: viewContext)

        // Test inserting a Ranking where EventRanking.qualStatus.eventStatus.event.key == eventKey
        let qualStatus = EventStatusQual.init(entity: EventStatusQual.entity(), insertInto: viewContext)
        ...
        let qualStatusRanking = EventRanking.insert(model, sortOrderInfo: nil, extraStatsInfo: nil, eventKey: event.key!, in: viewContext)
        ...
        ranking.event = event
        let eventRanking = EventRanking.insert(model, sortOrderInfo: nil, extraStatsInfo: nil, eventKey: event.key!, in: viewContext)
    ...
    func test_update() {
        ...
        let rankingOne = EventRanking.insert(modelOne, sortOrderInfo: sortOrderInfo, extraStatsInfo: extraStatsInfo, eventKey: event.key!, in: viewContext)
        ...
        let rankingTwo = EventRanking.insert(modelTwo, sortOrderInfo: nil, extraStatsInfo: nil, eventKey: event.key!, in: viewContext)
    ...
    func test_delete_orphan() {
        ...
        let ranking = EventRanking.insert(model, sortOrderInfo: nil, extraStatsInfo: nil, eventKey: event.key!, in: viewContext)
        event.addToRankings(ranking)

        let teamKey = ranking.teamKey!

        let qualStatus = EventStatusQual.insert(qualStatusModel, eventKey: event.key!, teamKey: "frc1", in: viewContext)
        ranking.qualStatus = qualStatus
