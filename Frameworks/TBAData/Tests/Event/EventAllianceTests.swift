...
class EventAllianceTestCase: TBADataTestCase {
    ...
    func test_insert() {
        ...
        let alliance = EventAlliance.insert(model, eventKey: event.key!, in: viewContext)
    ...
    func test_update() {
        ...
        let allianceOne = EventAlliance.insert(modelOne, eventKey: event.key!, in: viewContext)
        ...
        let allianceTwo = EventAlliance.insert(modelTwo, eventKey: event.key!, in: viewContext)
        ...
        let allianceThree = EventAlliance.insert(modelThree, eventKey: event.key!, in: viewContext)
    ...
    func test_delete_backup() {
        ...
        let allianceTwo = EventAlliance.insert(modelTwo, eventKey: eventTwo.key!, in: viewContext)
        ...
        // Should delete just fine
        viewContext.delete(allianceOne)
        XCTAssertNoThrow(try viewContext.save())
        ...
        viewContext.delete(allianceTwo)
        XCTAssertNoThrow(try viewContext.save())
    ...
    func test_delete_backup_status() {
        ...
        let allianceStatus = EventStatusAlliance.insert(allianceStatusModel, eventKey: event.key!, teamKey: "frc1", in: viewContext)
    ...
    func test_isOrphaned() {
        let alliance = EventAlliance.init(entity: EventAlliance.entity(), insertInto: viewContext)
