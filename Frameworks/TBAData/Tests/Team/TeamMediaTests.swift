...
class TeamMediaTestCase: TBADataTestCase {
    ...
    func test_insert() {
        ...
        let media = TeamMedia.insert(model, year: 2010, in: viewContext)
    ...
    func test_update_key() {
        ...
        let mediaOne = TeamMedia.insert(modelOne, year: 2010, in: viewContext)

        let modelTwo = TBAMedia(key: "key", type: "youtube", foreignKey: nil, details: nil, preferred: false)
        let mediaTwo = TeamMedia.insert(modelTwo, year: 2010, in: viewContext)
    ...
    func test_isOrphaned() {
        let media = TeamMedia.init(entity: TeamMedia.entity(), insertInto: viewContext)
