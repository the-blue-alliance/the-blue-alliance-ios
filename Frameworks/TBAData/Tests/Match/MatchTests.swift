...
class MatchTestCase: TBADataTestCase {
    ...
    func test_insert() {
        ...
        let match = Match.insert(model, in: viewContext)
    ...
    func test_update() {
        ...
        let matchOne = Match.insert(modelOne, in: viewContext)
        ...
        let matchTwo = Match.insert(modelTwo, in: viewContext)
    ...
    func test_find() {
        ...
        XCTAssertNil(Match.forKey(key, in: viewContext))
        _ = coreDataTestFixture.insertMatch()
        XCTAssertNotNil(Match.forKey(key, in: viewContext))
    }
