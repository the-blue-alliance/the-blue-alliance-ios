...
class AwardTestCase: TBADataTestCase {
    ...
    func test_update() {
        ...
        let modelOne = TBAAward(name: "The Fake Award",
                                ...
                                year: 2018)
        let awardOne = Award.insert(modelOne, in: viewContext)
        ...
        let modelTwo = TBAAward(name: "Some New Award",
                                ...
                                year: 2018)
        let awardTwo = Award.insert(modelTwo, in: viewContext)
        ...
        let awardThree = Award.insert(modelThree, in: viewContext)
    ...
    func test_delete() {
        ...
        let modelAwardOne = TBAAward(name: "The Fake Award",
                                  ...
                                  year: 2018)
        let awardOne = Award.insert(modelAwardOne, in: viewContext)
        let recipients = awardOne.recipients!.allObjects as! [AwardRecipient]
        ...
        let modelAwardTwo = TBAAward(name: "Some New Award",
                                     ...
                                     recipients: [frc2Model],
                                     year: 2018)
        let awardTwo = Award.insert(modelAwardTwo, in: viewContext)
        event.addToAwards(awardTwo)

        viewContext.delete(awardOne)
