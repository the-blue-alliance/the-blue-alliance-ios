...
/**
 Identifies a Core Data class as being Searchable in-app and via Spotlight. Values are used by CoreSpotlight index
 to ensure that we don't duplicate search results.
 */
